...
### Get Installer
The latest version is 1.4.6. Click on the link below to get the installer.
- [Nexial Installer v1.4.6](https://github.com/nexiality/nexial-installer/releases/download/nexial-installer-v1.4.6/nexial-installer-1.4.6.zip)
