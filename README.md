...
### Get Installer
The latest version is 1.4.4. Click on the link below to get the installer.
- [Nexial Installer v1.4.4](https://github.com/nexiality/nexial-installer/releases/download/nexial-installer-v1.4.4/nexial-installer-1.4.4.zip)
